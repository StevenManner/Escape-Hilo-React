...
const Header = (props) => {
  return (
    ...
    >
      ...
      <span className={` ${styles['text3']} ${projectStyles['textSM']} `}>
        FAQS
      </span>
      <span className={` ${styles['text4']} ${projectStyles['textSM']} `}>
        CONTACT
      </span>
      <span className={` ${styles['text5']} ${projectStyles['textSM']} `}>
        GIFT CARDS
      </span>
      ...
      <div data-type="MobileMenu" className={styles['MobileMenu']}>
        ...
        <div className={styles['Mid']}>
          ...
          <div className={styles['container4']}>
            ...
            <span className={` ${styles['text8']} ${projectStyles['textSM']} `}>
              BLOG
            </span>
          </div>
        </div>
...
Header.defaultProps = {
  ...
  image_alt: 'image',
  heading11: 'NOTUS PRO',
  image_src: '/playground_assets/escape-hilo-logo-red-300x75-200h.png',
}
